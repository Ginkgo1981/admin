...
export class MajorComponent implements OnInit {
  ...
  ngOnInit():void {
    ...
    console.debug("[major-component] ngOnInit major_dsin:%o, university_dsin:%o", this.major_dsin, this.university_dsin);
    this.load_major(this.major_dsin);
  }

  load_major(major_dsin: String){
    this._dsin_service.get_by_dsin(major_dsin).then(res => {
      console.debug("[major-component] load_major major_dsin: %o, res: %o", major_dsin, res.major.name)
      let major = res.major;
  ...
  onPhotoSelected(e){
    console.debug("[major-component] onPhotoSelected e: %o",e )
